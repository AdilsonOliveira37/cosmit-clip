install:
	...
	cp -f target/release/cosmic-clip-minimal ~/.local/bin/ 
	cp -f cosmic-clip-minimal.service ~/.config/systemd/user/
	cp -f assets/wofi-style.css ~/.config/wofi/cosmic-clip.css
